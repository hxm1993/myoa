    ...
    <div class="wrap ue-clear">
      <div class="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="agency">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>人员管理</span><i class="icon"></i></a></div>
            <ul class="subnav">
              <li><a href="javascript:;" date-src="<?php echo U('User/index');?>">人员列表</a></li>
              <li><a href="javascript:;" date-src="<?php echo U('User/add');?>">添加人员</a></li>
            </ul>
          </li>
