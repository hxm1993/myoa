...
<form action="<?php echo U('addOk');?>" id="myForm" method="post" enctype='multipart/form-data'>
<div class="main">
	<div id='showPic'></div>
	...
	<br />
	<div style='float:left;'><input id="file_upload" name="file_upload" type="file" multiple="true"></div>
